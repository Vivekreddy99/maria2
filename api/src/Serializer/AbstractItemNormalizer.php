...
abstract class AbstractItemNormalizer extends AbstractObjectNormalizer
{
    ...
    {
        // Converts select relationship id's to IRI's. Added CH.
        if (in_array($attributeName, array_keys($this->replaceIdsWithIRIs)) && strpos($attributeName, '/') === FALSE) {
            $value = $this->iriPrefix . $this->replaceIdsWithIRIs[$attributeName] . '/' . $value;
        }
